...
## High-level Steps
1. [Configure Model Info](#configure-model-info)
1. [Configure Explainability Metrics](#configure-explainability-metrics)
1. [Configure Evaluation Metrics: Fairness](#configure-fairness-metrics)
1. [Configure Evaluation Metrics: Quality](#configure-quality-metrics)
1. [Start Evaluation](#evaluate-now)

## Instructions
### **Configure Model Info**<a name="configure-model-info"></a>
...
### **Configure Explainability Metrics**<a name="configure-explainability-metrics"></a>
...
#### **Fairness**<a name="configure-fairness-metrics"></a>
...
#### **Quality**<a name="configure-quality-metrics"></a>
...
### Evaluate now<a name="evaluate-now"></a>
- One the configure monitor steps is completed, navigate back to the model summary page and click “Actions” button and select “Evaluate now”. 
![](./Instruction-Screenshots/EvaluateNow.png)
- A righthand side panel will appear to “Import test data”. Select “from CSV file” and select testing dataset file. In our example, the “test.csv” file. Click “Upload and Evaluate” to start the evaluation.
![](./Instruction-Screenshots/EvaluateNowImportTestData.png)
- The right hand side panel will close and you will see this following view saying “Evaluation in progress”, wait a few minutes to view evaluation results.
![](./Instruction-Screenshots/EvaluationInProgress.png)
- After a few minutes, you will see the evaluation dashboard similar to the screenshot. You’ve finished configuring model governance for a classification model.
![](./Instruction-Screenshots/EvaluationComplete.png)
